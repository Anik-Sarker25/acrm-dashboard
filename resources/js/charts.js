...
function initializeChart(containerId, option) {
...
function chart10() {
  ...
  initializeChart("chart10", option);
}
// chart11
function chart11() {
  option = {
  ...
  initializeChart("chart11", option);
}
// chart12
function chart12() {
  option = {
  ...
  initializeChart("chart12", option);
}
// chart13
function chart13() {
  option = {
  ...
  initializeChart("chart13", option);
}
// chart14
function chart14() {
  option = {
  ...
  initializeChart("chart14", option);
}
// chart15
function chart15() {
  option = {
